  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const endpoint = formData.userType === 'admin'
        ? 'https://csa-backend.vercel.app/admin/signin'
        : 'https://csa-backend.vercel.app/user/signin';
      ...
      if (response.ok) {
        ...
        localStorage.setItem('userType', formData.userType); // Fixed: use formData.userType
        navigate('/');
      } else {
